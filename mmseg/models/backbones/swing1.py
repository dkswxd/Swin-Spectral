...
class SwinTransformerGroup1(BaseModule):
    ...
    def __init__(self,
        ...
        super(SwinTransformerGroup1, self).__init__()
    ...
    def forward(self, x):
        ...
        x = x.view(true_batchsize * true_channel, 1, true_h, true_w)
        ...
        for i, stage in enumerate(self.stages):
            ...
            if i in self.out_indices:
                ...
                if self.use_spectral_aggregation == 'Max':
                    out = out.view(true_batchsize, true_channel, self.num_features[i], *out_hw_shape)
                    out = out.max(dim=1)[0]
